...
from e2e.pages.dashboard.books.fashion.book_list_page import BookListPage
from e2e.pages.dashboard.books.fashion.read_book_page import BookReadPage

from playwright.sync_api import sync_playwright


def test_book_read_fashion():
    with sync_playwright() as playwright:
        ...
        # Prepare CSV file
        with open("books_read_fashion.csv", "w", newline="") as csvfile:
